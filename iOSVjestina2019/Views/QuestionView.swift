...
class QuestionView: UIView {
    ...
    func populate(with question: QuestionViewModel) {
        ...
        answerButtons[0].setTitle(question.answers[0], for: UIControl.State.normal)
        answerButtons[1].setTitle(question.answers[1], for: UIControl.State.normal)
        answerButtons[2].setTitle(question.answers[2], for: UIControl.State.normal)
        answerButtons[3].setTitle(question.answers[3], for: UIControl.State.normal)
    }
